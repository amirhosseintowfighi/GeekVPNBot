 ...
 *
 * `glow` adds the gradient ring used to mark the one thing on a screen that
 * matters most - the featured plan, the active subscription. It is a prop
 * rather than a variant because at most one card per screen should carry it;
...
>(({ className, glow, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      glow && 'ring-gradient shadow-lg shadow-primary/10',
      className,
    )}
    {...props}
  />
