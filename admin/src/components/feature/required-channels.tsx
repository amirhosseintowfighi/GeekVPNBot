    ...
    <Card className="space-y-4 p-4">
      <div>
        ...
        <p className="mt-1 text-2xs text-muted-foreground">
          تا وقتی کاربر عضو همهٔ کانال‌های فعال نشده باشه، ربات بهش سرویس
          نمی‌ده. اگه هیچ کانالی اضافه نکنی، هیچ اجباری در کار نیست.
        </p>
        <p className="mt-1 text-2xs text-warning">
          ربات باید تو اون کانال ادمین باشه، وگرنه نمی‌تونه عضویت رو بررسی کنه —
          و کانالی که قابل بررسی نباشه نادیده گرفته می‌شه تا کسی پشت در نمونه.
        </p>
      </div>
      ...
      <div className="space-y-3 rounded-md border p-3">
        ...
        <Field label="نامی که به کاربر نشون داده می‌شه">
          <Input
            value={titleFa}
        ...
        <Field
          ...
          hint={
            isPrivate
              ? 'کانال خصوصی لینکی نداره که ساخته شه، پس بدون این، کاربر راهی برای عضو شدن نداره.'
              : 'برای کانال عمومی از روی شناسه ساخته می‌شه.'
          }
        >
          <Input
            dir="ltr"
